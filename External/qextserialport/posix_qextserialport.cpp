...
#ifdef CBAUD
				Posix_CommConfig.c_cflag&=(~CBAUD);
				Posix_CommConfig.c_cflag|=B1000000;
#else
				cfsetispeed(&Posix_CommConfig, B1000000);
				cfsetospeed(&Posix_CommConfig, B1000000);
#endif
				break;
#endif
...
#ifdef CBAUD
				Posix_CommConfig.c_cflag&=(~CBAUD);
				Posix_CommConfig.c_cflag|=B2000000;
#else
				cfsetispeed(&Posix_CommConfig, B2000000);
				cfsetospeed(&Posix_CommConfig, B2000000);
#endif
				break;
#endif
...
#ifdef CBAUD
				Posix_CommConfig.c_cflag&=(~CBAUD);
				Posix_CommConfig.c_cflag|=B2500000;
#else
				cfsetispeed(&Posix_CommConfig, B2500000);
				cfsetospeed(&Posix_CommConfig, B2500000);
#endif
				break;
#endif
...
#ifdef CBAUD
				Posix_CommConfig.c_cflag&=(~CBAUD);
				Posix_CommConfig.c_cflag|=B3000000;
#else
				cfsetispeed(&Posix_CommConfig, B3000000);
				cfsetospeed(&Posix_CommConfig, B3000000);
#endif
				break;
#endif
...
#ifdef CBAUD
				Posix_CommConfig.c_cflag&=(~CBAUD);
				Posix_CommConfig.c_cflag|=B3500000;
#else
				cfsetispeed(&Posix_CommConfig, B3500000);
				cfsetospeed(&Posix_CommConfig, B3500000);
#endif
				break;
#endif
...
#ifdef CBAUD
				Posix_CommConfig.c_cflag&=(~CBAUD);
				Posix_CommConfig.c_cflag|=B4000000;
#else
				cfsetispeed(&Posix_CommConfig, B4000000);
				cfsetospeed(&Posix_CommConfig, B4000000);
#endif
				break;
#endif

				default:
					TTY_WARNING("QextSerialPort: Baud rate not supported.  Switching to 115200 baud.");
	#ifdef CBAUD
					Posix_CommConfig.c_cflag&=(~CBAUD);
					Posix_CommConfig.c_cflag|=B115200;
	#else
